"""
Django settings for purple_recipe_40492 project.
...
ROOT_URLCONF = 'purple_recipe_40492.urls'
...
WSGI_APPLICATION = 'purple_recipe_40492.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_recipe_40492 API",
    "DESCRIPTION": "API documentation for purple_recipe_40492 App",
    "VERSION": "v1",
}
